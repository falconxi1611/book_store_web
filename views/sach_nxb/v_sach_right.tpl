			...
			<div class="agile_ecommerce_tab_left dresses_grid">
				<div class="hs-wrapper hs-wrapper2" >
					...
					<div class="w3_hs_bottom w3_hs_bottom_sub1">
						<ul>
							<li>
								<a href="chi_tiet_sach.php" data-toggle="modal" data-target="#sach{$sach->id}"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
							</li>
						</ul>
					</div>
				</div>
				<h5 class="my_ten_sach"><a href="sach_chi_tiet?id={$sach->id}">{$sach->ten_sach}</a></h5>
