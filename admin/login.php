...
<head>
<link rel="shortcut icon" href="public/layout/resources/images/icons/Aha-Soft-Free-Large-Boss-Admin.ico">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Quản lý Nhà Sách FT Store | Đăng nhập</title>
...
<body id="login">
		<div id="login-wrapper" class="png_bg">
			<div id="login-top">
              <h1>Quản lý Nhà Sách FT-Store</h1>
			<!-- Logo (221px width) --><img src="public/layout/resources/images/admin.jpg" alt="Nhà Hàng Admin logo" width="344" height="333" id="logo" /></div> <!-- End #logn-top -->
