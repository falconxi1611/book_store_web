	...
	<div class="container">
		<div class="w3l_login">
				...
				<li class="dropdown">
					<a data-toggle="dropdown" class="dropdown-toggle" href="#">
						<img alt="" width="50px" height="50px"
							 src="public/layout/hinh_user/{$avatar}">
					</a>
					<ul id="login" class="dropdown-menu extended logout">
						...
						<li><a href="login.php?logout" style="height: 40px; width: auto;font-size: 13px"><i
			...
			{else}
				...
				<a href="login.php" style="border: 1px solid #BEBEBE;"><span class="glyphicon glyphicon-user"
