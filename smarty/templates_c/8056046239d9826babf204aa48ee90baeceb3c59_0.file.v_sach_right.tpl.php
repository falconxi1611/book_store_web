...
/* Smarty version 3.1.32-dev-11, created on 2017-08-30 06:53:54
  from "C:\wamp64\www\Book_Store_Project_30.07.2017\views\sach_nxb\v_sach_right.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32-dev-11',
  'unifunc' => 'content_59a66102e81421_19653009',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8056046239d9826babf204aa48ee90baeceb3c59' => 
    array (
      0 => 'C:\\wamp64\\www\\Book_Store_Project_30.07.2017\\views\\sach_nxb\\v_sach_right.tpl',
      1 => 1501042460,
      2 => 'file',
    ),
  ),
...
function content_59a66102e81421_19653009 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="w3ls_dresses_grid_right_grid2" >
	...
	<div class="w3ls_dresses_grid_right_grid2_right">
		<select name="select_item" class="select_item" id="loc_sach" onChange="Loc_sach($('#loc_sach').val())">
			<option selected="selected" value="mac_dinh">Mặc định</option>
			<option value="ten_ASC">Lọc theo tên từ A->Z</option>
			<option value="ten_DESC">Lọc theo tên từ Z->A</option>s
			<option value="gia_ASC">Sắp xếp theo giá thấp nhất</option>
			<option value="gia_DESC">Sắp xếp theo giá cao nhất</option>
		</select>
	</div>
...
<div class="w3ls_dresses_grid_right_grid3" id="ket_qua">
...
" alt=" " class="img-responsive" />
					<div class="w3_hs_bottom w3_hs_bottom_sub1">
						<ul>
							<li>
								<a href="chi_tiet_sach.php" data-toggle="modal" data-target="#sach<?php echo $_smarty_tpl->tpl_vars['sach']->value->id;?>
"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
							</li>
						</ul>
					</div>
				</div>
				<h5 class="my_ten_sach"><a href="sach_chi_tiet?id=<?php echo $_smarty_tpl->tpl_vars['sach']->value->id;?>
